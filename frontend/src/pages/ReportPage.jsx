      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6">
            ...
            {previewImg && (
              <img src={previewImg} alt="Report preview" className="w-full rounded-xl border border-slate-100 mb-5" />
            )}
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold py-3 rounded-xl transition-colors"
              >
